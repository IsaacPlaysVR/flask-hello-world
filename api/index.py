...
class GameInfo:
    ...
    def __init__(self):
        titleider: str = "EAE1B"
        secretkey: str = "RWRAA16JI9G3E4YHEJXBYZ66XCAJBNI3WQUARG96JF3C88MPO5"
        self.ApiKey: str = "OC|9437244213066805|64454ef932f88b48ac0ea0a000327d8d"
...
titleider = "EAE1B"
secretkey = "RWRAA16JI9G3E4YHEJXBYZ66XCAJBNI3WQUARG96JF3C88MPO5"
settings.ApiKey = "OC|9437244213066805|64454ef932f88b48ac0ea0a000327d8d"
...
def ReturnFunctionJson(data, funcname, funcparam={}):
    ...
    req = requests.post(
        url=f"https://EAE1B.playfabapi.com/Server/ExecuteCloudScript",
        json={
            "PlayFabId": userId,
...
def playfabauthentication():
    ...
    url = f"https://EAE1B.playfabapi.com/Server/LoginWithServerCustomId"
